...
class SearchMelanomaV1MobileNet(nn.Module):
    def __init__(self,
                 in_C=4,  # number of input channels
                 width_stages=[24,40,80,96],  #,192,320],
                 n_cell_stages=[4,4,4,1],  #4,4,1],
                 stride_stages=[2,2,2,1],  #,2,1],
                 width_mult=1, n_classes=n_classes,
        ...
        """
        super(SearchMelanomaV1MobileNet, self).__init__()
        ...
        # first conv
        first_conv = ops.ConvLayer(in_C, input_channel, kernel_size=3, stride=2, use_bn=True, act_func='relu6', ops_order='weight_bn_act')
        # first block
