...
if __name__ == "__main__":
    ...
    layers_list = [4,5]
    # epochs_list = [350, 350,  350, 350, 350]
    cuda_id_ = 1
    do_visualize = True
    ...
    for L in layers_list:
        runs_args.append(
            SimpleNamespace(layers=L, batch_size=batch_size, log_frequency=10, epochs=epochs, channels=9, unrolled=False, \
                            ...
                            cuda_id=cuda_id_, \
                            target_folder_name='/mnt/models/darts_retrained/4ch_128x128_12inchannel_no_metainfo_registered_5Fold_newC43_augC43_v1_21Dec2020_32classes/XV2_SGD_orig_02DropChannel_{}lrs_15Dec_newC43NoDup_ClassSet8_ManCorected_registered_350epochs'.format(L), \
