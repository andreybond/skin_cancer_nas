import triple_combinations_2_InV3 as tc2
import math
import logging
import random
import argparse
...
def hyperopt_objective(args_):
    ...
    try:
        ...
        exp = Experiment('Triplets 2 IncV3. v2')
...
def run_with_global_args():
    ...
    try:
        ...
        all_results = tc2.objective(args=args, f_log_metrics=my_metrics)  #inner_objective(args)
...
if __name__ == '__main__':
    ...
    for triple_arg in triple_combs:
        ...
        df_row = df_summary.loc[(df_summary['name']=='Triplets 2 IncV3. v2') & (df_summary['ch1']==triple_arg[0]) & (df_summary['ch2']==triple_arg[1]) & (df_summary['ch3']==triple_arg[2])]
        print(df_row)
        # run_exp_flag = False
        if df_row.shape[0] == 0:
